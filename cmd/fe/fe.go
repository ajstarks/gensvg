...
func main() {
	...
	gfs := gensvg.Filterspec{In: "SourceAlpha", Result: "blur"}
	ofs := gensvg.Filterspec{In: "blur", Result: "offsetBlur"}
	sfs := gensvg.Filterspec{In: "blur", Result: "specOut"}
	cfs1 := gensvg.Filterspec{In: "specOut", In2: "SourceAlpha", Result: "specOut"}
	cfs2 := gensvg.Filterspec{In: "SourceGraphic", In2: "specOut", Result: "litPaint"}
