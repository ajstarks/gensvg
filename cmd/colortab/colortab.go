...
func main() {
	var (
		...
		fontsize               = flag.Float64("fs", 12, "fontsize")
		width                  = flag.Float64("w", 1600, "width")
		height                 = flag.Float64("h", 900, "height")
		rowsize                = flag.Int("r", 32, "rowsize")
		colw                   = flag.Float64("c", 320, "column size")
		swatch                 = flag.Float64("s", 16, "swatch size")
		gutter                 = flag.Float64("g", 11, "gutter")
		err                    error
	...
	canvas.Gstyle(fmt.Sprintf("font-family:%s;font-size:%vpt;fill:%s",
