# gensvg: A Go library for SVG generation #
...
### Shapes, lines, text
 ...
 circle, ellipse, polygon, polyline, rect (including roundrects), line, text, tspan
...
Usage: (assuming GOPATH is set)
	...
	go get github.com/ajstarks/gensvg
...
### Graphics Sketching with gensvg and svgplay ###

Combined with the svgplay command, gensvg can be used to "sketch" with code in a browser.  

To use svgplay and gensvg, first go to a directory with your code, and run:
...
on the right.  To update, change the code and repeat. Note that compilation errors are shown in red under the code. In order for svgplay/gensvg to work, make sure that the io.Writer specified with the New function is os.Stdout.
